...
export function LandingPage() {
  return (
    <div className="bg-[#1a1625] w-full h-screen pt-16 md:pt-0">
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-700 to-gray-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
          <div className="text-center">
            <div className="mb-3">
            <span className="bg-gray-500/20 text-gray-200 px-4 py-1 rounded-full text-sm">
            ...
            <h1 className="text-4xl md:text-7xl font-black tracking-tight text-white mb-6 font-['Montserrat'] uppercase leading-tight">
              Super<span className="text-gray-400 font-brand">Brain</span>
            </h1>
            ...
            <Link to="https://github.com/eswaredits/mindstash">
            <motion.button 
